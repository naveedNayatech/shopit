...
const Cart = ({ history }) => {
    ...
    const increaseQuantity = (id, quantity, stock) => {
        ...
        if(newQty > stock)  {
            alert.error(`Not more than ${newQty} in stock`);
            return
        };
                ...
                <div className="row d-flex justify-content-between">
                    ...
                    <div className="col-12 col-lg-3 my-4">
                        <div id="order_summary">
                            ...
                            <p>Est. total: <span className="order-summary-values">${(cartItems.reduce((acc, item) => (acc + Number(item.price) * item.quantity), 0)).toFixed(2)}</span></p>
